        ...
        <div className='bg-[rgba(12,12,12,0.9)] border-t border-white/5 inset-shadow-sm inset-shadow-[]  items-center justify-between px-3 py-3 w-full z-20 '>
            ...
            <div className='flex items-center justify-around'>
                <div>
                    ...
                    <h1 className='font-bold text-orange-500 text-lg'>Asif Ekhlaque</h1>
                    <p className='text-gray-300 text-sm'>Full Stack Developer . Graphic Designer</p>
                </div>
                <div className='flex gap-4 text-gray-200 '>
                    <a href='https://www.instagram.com/asif_0484_/' target="_blank" rel="noopener noreferrer"><Instagram className='hover:text-orange-500' /></a>
